...
internal val logger: SkipLogger = SkipLogger(subsystem = "carrot.module", category = "Carrot")

private typealias AppRootView = CarrotRootView
private typealias AppDelegate = CarrotAppDelegate
